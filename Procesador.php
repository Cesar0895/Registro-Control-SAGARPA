...
<body>
	...
	<div class="container">
		<div class="card">
			<form>
				<div class="form-group">
					...
					<input type="text" class="form-control" id="procesador" name="Procesador" placeholder="Procesador" require>
				</div>
				<div class="form-group">
        ...
        if ($procesador!=null) {
            $sqlprocesador= "INSERT INTO procesador (Procesador) VALUES ('$procesador')";
