...
session_start();
    ...
    $row = $resultado->fetch_array(MYSQLI_ASSOC);
		...
		$id_vel=$_GET['Id_velocidad'];
        $velocidad = $_GET['Velocidad'];
        if ($velocidad!=null) {
            $sqlvelocidad= "UPDATE `velocidad` SET `Velocidad`='$velocidad' WHERE Id_velocidad='$id_vel'";
		...
		$sql = "SELECT * FROM `velocidad` WHERE Id_velocidad='$id_vel'";
		...
		<div class="card">
			<form>
				<div class="form-group">
					<h5 class="card-title">Veslocidad de procesador</h5>
					<input type="hidden" class="form-control" id="velocidad" name="Id_velocidad"  value="<?php echo $row['Id_velocidad'] ?>" require>

					<input type="text" class="form-control" id="velocidad" name="Velocidad" value="<?php echo $row['Velocidad'] ?>" require>
				</div>
				<div class="form-group">
			...
			<a href="vistaVelocidad.php" class="btn btn-success">Ver lista de velocidades registradas</a>
