<?php
	...
	$id_disp = $_GET['Id_Dispositivo'];
	$sql2 = "DELETE FROM dispositivos WHERE Id_Dispositivo = '$id_disp'";
	...
	if(!empty($_POST))
	{
		...
		if(!empty($valor)){
			$where = "WHERE Nomb_Dispositivo LIKE '%$valor' or Tipo LIKE '%$valor'";
		}
	}

	$sqlmostrar = "SELECT * FROM dispositivos $where";
					...
					<table class="table table-hover table-secondary">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="ModificaDispositivos.php?Id_Dispositivo=<?php echo $row['Id_Dispositivo']; ?>">
