...
session_start();
    ...
    $row = $resultado->fetch_array(MYSQLI_ASSOC);
		...
		$id_proce=$_GET['id_Procesador'];
        $procesador = $_GET['Procesador'];
        if ($procesador!=null) {
            $sqlprocesador= "UPDATE `procesador` SET `Procesador`='$procesador' WHERE id_Procesador='$id_proce'";
		...
		$sql = "SELECT * FROM `procesador` WHERE id_Procesador='$id_proce'";
		...
		<div class="card">
			<form>
				<div class="form-group">
					<h5 class="card-title">Tipo de procesador</h5>
					<input type="hidden" class="form-control" id="procesador" name="id_Procesador" value="<?php echo $row['id_Procesador'] ?>" require>

					<input type="text" class="form-control" id="procesador" name="Procesador" value="<?php echo $row['Procesador'] ?>" require>
				</div>
				<div class="form-group">
			...
			<a href="vistaProcesador.php" class="btn btn-success">Ver lista de procesadores registrados</a>
