<?php
	...
	$sql2 = "DELETE FROM velocidad WHERE Id_velocidad = '$id_vel'";
	...
	if(!empty($_POST))
	{
		...
		if(!empty($valor)){
			$where = "WHERE Velocidad LIKE '%$valor'";
		}
	}

	$sqlmostrar = "SELECT * FROM velocidad ORDER BY `velocidad`.`Velocidad` ASC
	";
					...
					<table class="table table-hover table-secondary">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="ModificaVelocidad.php?Id_velocidad=<?php echo $row['Id_velocidad']; ?>">
