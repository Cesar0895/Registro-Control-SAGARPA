...
<body>
	...
	<div class="container">
		<div class="card">
			<form>
				<div class="form-group">
					...
					<input type="text" class="form-control" id="dd" name="DD" placeholder="Capacidad de almacenamiento" require>
				</div>
				<div class="form-group">
        ...
        $disco = $_GET['DD'];
        if ($disco!=null) {
            $sqldisco= "INSERT INTO disco_duro (Almacenamiento) VALUES ('$disco')";
            $mysqli->query($sqldisco);

            if ($disco=1) {
                header("location:vistaDiscoDuro.php");
            }
        }
