...
session_start();
    ...
    $row = $resultado->fetch_array(MYSQLI_ASSOC);
		...
		$Sigla=$_GET['Sigla'];
        if ($zona!=null) {
            $sqlzona= "UPDATE `zona` SET `Nombre`='$zona',`Sigla`='$Sigla' WHERE `id_Zona`='$id_Zona'";
		...
		<div class="card">
			<form>
				<div class="form-group">
					...
					<input type="hidden" class="form-control" id="zona" name="id_Zona"  value="<?php echo $row['id_Zona'] ?>" require>

					<input type="text" class="form-control" id="zona" name="Nombre" placeholder="Escribe una zona" value="<?php echo $row['Nombre'] ?>" require>

					<input type="text" class="form-control" id="zona" name="Sigla" placeholder="Sigla" value="<?php echo $row['Sigla'] ?>" require>
				</div>
				<div class="form-group">
			...
			<a href="vistaZonas.php" class="btn btn-success">Ver lista de zonas registradas</a>
