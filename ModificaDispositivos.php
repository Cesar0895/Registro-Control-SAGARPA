...
session_start();
    ...
    $row = $resultado->fetch_array(MYSQLI_ASSOC);
		...
		$id_dispo=$_GET['Id_Dispositivo'];
		$disp = $_GET['Dispositivo'];
		$tipo = $_GET['Tipo'];
        if ($disp!=null && $tipo!=null) {
            $sqldisp= "UPDATE `dispositivos` SET `Nomb_Dispositivo`='$disp',`Tipo`='$tipo' WHERE Id_Dispositivo='$id_dispo'";
		...
		$sql = "SELECT * FROM `dispositivos` WHERE Id_Dispositivo='$id_dispo'";
		...
		<div class="card">
			<form>
				<div class="form-group">
					...
					<input type="hidden" class="form-control" id="dispositivo" name="Id_Dispositivo" value="<?php echo $row['Id_Dispositivo']; ?>" require>

					<input type="text" class="form-control" id="dispositivo" name="Dispositivo" value="<?php echo $row['Nomb_Dispositivo']; ?>" require>

					<input type="text" class="form-control" id="tipo" name="Tipo" value="<?php echo $row['Tipo']; ?>" require>
