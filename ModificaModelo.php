<?php
    ...
    $row = $resultado->fetch_array(MYSQLI_ASSOC);
        ...
        $modelo = $_GET['Modelo'];
        if ($modelo!=null) {
			$sqlmodelo= "UPDATE `modelo` SET `Modelo`='$modelo' WHERE id_Modelo='$idModelo'";
		...
		$sql = "SELECT * FROM `modelo` WHERE id_Modelo='$idModelo'";
	...
	<div class="container">
		<div class="card">
			...
			<div class="form-group">
					...
					<input type="hidden" class="form-control" id="modelo" name="id_Modelo" value="<?php echo $row['id_Modelo']; ?>" require>
				</div>
				<div class="form-group">
					<h5 class="card-title">Modelo</h5>
					<input type="text" class="form-control" id="modelo" name="Modelo" value="<?php echo $row['Modelo']; ?>" require>
				</div>
				<div class="form-group">
