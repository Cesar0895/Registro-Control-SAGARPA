<?php
		...
		$estatus = $_GET['Estatus'];        
            ...
            if ($extencion!=null) {
                $sql= "INSERT INTO telefonia  (Extencion, Display, RFC, Inmueble, Sitio,Serie, Marca, Modelo, Mac, NodoRed, GpoCaptura, Nivel_Cor, Nivel_Aut, Codigo_Aut, Funcion, DID, CorreoVoz, Puerto, Dir_IP, Mask, Gateway, VLAN, Notas, Adquisicion, Eliminador, F_Resguardo, Fecha_Resguardo, Observaciones, Estatus)
		...
		<div class="card">
			...
			<div class="card-body">
				<form>
					...
					<div class="form-group">
						<label class="col-sm-2 controllabel">RFC</label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label class="col-sm-2 controllabel">Marca</label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label class="col-sm-2 controllabel">Modelo</label>
						<div class="col-sm-10">
