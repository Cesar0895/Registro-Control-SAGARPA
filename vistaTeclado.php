<?php
	...
	$sqlmostrar = "SELECT t.Id_Teclado, t.Serie, t.Inventario, t.Descripcion, t.Adquisicion, marca.Marca, modelo.Modelo FROM teclado t INNER JOIN marca ON t.Id_Marca=marca.id_Marca INNER JOIN modelo on t.IdModelo=modelo.id_Modelo $where";
