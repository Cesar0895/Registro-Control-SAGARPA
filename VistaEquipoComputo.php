					...
					<table class="table table-hover table-secondary">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="ModificaInventario.php?Folio=<?php echo $row['Folio']; ?>">
