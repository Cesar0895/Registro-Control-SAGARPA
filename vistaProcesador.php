<?php
	...
	$sql2 = "DELETE FROM procesador WHERE id_Procesador = '$id_procesador'";
	...
	if(!empty($_POST))
	{
		...
		if(!empty($valor)){
			$where = "WHERE Procesador LIKE '$valor%'";
		}
	}

	$sqlmostrar = "SELECT * FROM procesador $where ORDER BY Procesador ASC";
					...
					<table class="table table-hover table-secondary">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="ModificaProcesador.php?id_Procesador=<?php echo $row['id_Procesador']; ?>">
