<?php	
    ...
    $row = $resultado->fetch_array(MYSQLI_ASSOC);
		...
		if ($RFC!='CUAJ800423F77' && $RFC!='BUVG860908DU8') {
            ...
            if ($serieMou!=null) {
				$sql2= "UPDATE mouse SET Serie='$serieMou',Id_Marca='$id_MarcaMou',Modelo='$id_ModeloMou', Descripcion='$descripcionMou', Inventario='$inventarioMou', Adquisicion='$adquiMou' WHERE Id_mouse='$idMou'";
...
require 'conexion.php';
			...
			$sql = "SELECT mou.Id_mouse, mou.Serie, mou.Inventario, mou.Descripcion,mou.Adquisicion, marca.Marca, marca.id_Marca, mou.Modelo FROM mouse mou 
			INNER JOIN marca ON mou.Id_Marca=marca.id_Marca 
			where Id_mouse='$idMou'";
