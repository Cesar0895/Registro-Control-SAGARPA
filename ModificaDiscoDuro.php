...
session_start();
    ...
    $row = $resultado->fetch_array(MYSQLI_ASSOC);
        ...
        $disco = $_GET['DD'];
        if ($disco!=null) {
            $sqldisco= "UPDATE `disco_duro` SET `Almacenamiento`='$disco' WHERE id_DD='$id_DD'";
            $mysqli->query($sqldisco);
		...
		$sql = "SELECT * FROM `disco_duro` WHERE id_DD='$id_DD' ";
		...
		<div class="card">
			<form>
				<div class="form-group">
					<h5 class="card-title">Capacidad de almacenamiento en disco duro</h5>
					<input type="hidden" class="form-control" id="dd" name="id_DD" value="<?php echo $row['id_DD']; ?>" require>

					<input type="text" class="form-control" id="dd" name="DD" value="<?php echo $row['Almacenamiento']; ?>" require>
				</div>
				<div class="form-group">
			...
			<a href="vistaDiscoDuro.php" class="btn btn-success">Ver lista de almacenamiento registrados</a>
