...
$row = $resultado->fetch_array(MYSQLI_ASSOC);
	...
	$sql2 = "DELETE FROM disco_duro WHERE id_DD = '$id_DD'";
	...
	if(!empty($_POST))
	{
		...
		if(!empty($valor)){
			$where = "WHERE Almacenamiento LIKE '%$valor'";
		}
	}

	$sqlmostrar = "SELECT * FROM disco_duro $where";
	...
	<main role="main" class="container">
		<div class="card">
			...
			<div class="card-body">
				...
				<a href="DiscoDuro.php" class="btn btn-primary float-right">Nuevo Registro</a>
					...
					<table class="table table-hover table-secondary">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="ModificaDiscoDuro.php?id_DD=<?php echo $row['id_DD']; ?>">
										<span class="far fa-edit"></span>
									</a>
								</td>
								<td>
									<a href="vistaDiscoDuro.php" data-href="vistaDiscoDuro.php?id_DD=<?php echo $row['id_DD']; ?>"
